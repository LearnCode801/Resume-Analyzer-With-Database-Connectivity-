...
connection = pymysql.connect(host='localhost',user='root',password='03214090997',db='cv')
...
def run():
    ...
    link = '[©Developed by Muhammad Talha](https://www.linkedin.com/in/muhammad-talha-806126234/'
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Uploading your Resume...'):
                time.sleep(4)
            save_image_path = './uploaded resume/'+pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'talha' and ad_password == '12345':
